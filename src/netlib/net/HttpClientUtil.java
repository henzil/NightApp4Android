...
public class HttpClientUtil {
	...
	private static final int SET_CONNECTION_TIMEOUT = 2000;
	private static final int SET_SOCKET_TIMEOUT = 4000;
...
//				}
				...
				return BaseReturnCodeConstant.SCORECT_EXCEPTION;
			}
...
//	}
	...
	public static DefaultHttpClient getNewHttpClient(Context context, int connectionTimeout, int socketTimeout) {
		...
		try {
			...
			/**
			 * 时候用cmwap需要设置代理，使用wifi和cmnet则不需要设置代理（如果设置代理则得不到数据）
			 * */
